...
{
    public class MitsubishiEventIO : RegularByteTransform, IEventIO
    {
        public MitsubishiEventIO():base(DataFormat.CDAB)
        {
            
        }

        public MitsubishiEventIO(DataFormat dataFormat) : base(dataFormat)
        {
