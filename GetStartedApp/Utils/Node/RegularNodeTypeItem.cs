...
namespace GetStartedApp.Utils.Node
{
    public class RegularNodeTypeItem
    {
        ...
        public RegularNodeTypeItem(int code, string text, IImmutableSolidColorBrush backColor, int length)
        {
            Code = code;
            Text = text;
            BackColor = backColor;
        ...
        /// 类型使用的背景色
        /// </summary>
        public IImmutableSolidColorBrush BackColor { get; set; }
