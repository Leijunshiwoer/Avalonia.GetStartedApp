...
namespace GetStartedApp.ViewModels.PLC
{
    ...
    public class ConnSiemensViewModel : ViewModelBase, ISiemensEventExecuter, IOmronEventExecuter, IMitsubishiEventExecuter, IBeckhoffEventExecuter
    {
        ...
        public EventOmronThreadState HandleEvent(EventOmronThreadState se)
        {
            return se;
        }
        /// <summary>
        ...
        public EventMitsubishiThreadState HandleEvent(EventMitsubishiThreadState se)
        {
            return se;
        }
        /// <summary>
        ...
        private void OnErrCallback(string obj)
        {
